...
namespace 领取淘金币
{
    ...
    ///<param name="e"></param>   
    public delegate void WebClientUploadEvent(object sender, 领取淘金币.UploadEventArgs e);
    ...
    ///<param name="sender"></param>   
    ///<param name="e"></param>   
    public delegate void WebClientDownloadEvent(object sender, 领取淘金币.DownloadEventArgs e);
