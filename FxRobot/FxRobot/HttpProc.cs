...
namespace FxRobot
{
    ...
    {
        public static string strMobile = null;
        public static string strReferer = null;
        ...
        static HttpRequestCacheLevel cacheLevel = HttpRequestCacheLevel.Default;
        public object Tag;
        static WebClient()
        {
            LoadCookiesFromDisk();
        ...
        /// 设置缓存级别 
        /// </summary> 
        public static HttpRequestCacheLevel CacheLevel
        {
        ...
        private HttpWebRequest CreateRequest(string url, string method)
        {
            ...
            HttpRequestCachePolicy policy = new HttpRequestCachePolicy(cacheLevel);
        ...
        private static void SaveCookiesToDisk()
        {
            ...
            string cookieFile = System.Environment.GetFolderPath(Environment.SpecialFolder.Cookies) + "\\" + strMobile + ".cookie";
            FileStream fs = null;
            try
            {
