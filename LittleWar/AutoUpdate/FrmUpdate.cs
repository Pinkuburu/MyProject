...
namespace AutoUpdate
{
	...
	public class FrmUpdate : System.Windows.Forms.Form
	{
        ...
        private void FrmUpdate_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
                tempUpdatePath = "temp\\";//"_" + updaterXmlFiles.FindNode("//Application").Attributes["applicationId"].Value + "_" + "y" + "_" + "x" + "_" + "m" + "_" + "\\";
...
//				btnNext.Enabled = false;
		...
		private void DownUpdateFile()
		{
			...
			{
				string UpdateFile = this.lvUpdateList.Items[i].Text.Trim();
				string updateFileUrl = updateUrl + this.lvUpdateList.Items[i].Text.Trim();
				long fileLength = 0;
				...
				{	
                    ...
                    string tempPath = tempUpdatePath + UpdateFile;//tempUpdatePath
                    ...
                    //    Directory.Delete(tempUpdatePath);// CreateDirectory(temp);
				}
