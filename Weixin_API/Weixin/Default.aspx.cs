...
namespace Weixin
{
    ...
    {
        private readonly string Token = "d13a661162ccf33e59f2d5aed8ad9c44";//与微信公众账号后台的Token设置保持一致，区分大小写。
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            bool blDebug = Convert.ToBoolean(ConfigurationManager.AppSettings["Debug"]);
