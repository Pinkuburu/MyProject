...
if (mxapi.version == "1.x") {
	...
	if (mxapi.version == "2.x") {
		...
		mxapi.history = (function () {
				...
				function d(j) {
					var i = external.max_getObject(external.max_getFlag(), "INIManager");
					var l = "$main";
					var h = "mxstart";
					var f = (j == undefined) ? "true" : j.toString();
					var g = "defaultPopup";
					if (j != undefined) {
						try {
							i.fileName = l;
							...
							try {
								external.max_writeConfig(f, g, "section", "main");
							} catch (k) {
								throw new Error("browser don't support api: defaultPopup.");
							}
						}
					} else {
						try {
							i.fileName = l;
							i.load();
							f = i.readValue(h, g, "__na__");
							if (f == "__na__") {
								f = "true";
							}
						} catch (k) {
							try {
								f = external.max_readConfig("main", "section", g);
							} catch (k) {
								throw new Error("browser don't support api: defaultPopup.");
							}
						}
...
Core.reg("search-bar", function (f) {
		var h = [{
				...
				engines : [{
						...
						buttonText : "百度一下",
						logo : {
							img : "/images/skins/AsianGames/cooperator/baidu.2011021201.gif",
							url : "http://www.baidu.com/index.php?tn=myie2&ch=1"
						},
						submitData : {
						...
						buttonText : "Google",
						logo : {
							img : "/images/skins/AsianGames/cooperator/google.2011021201.gif",
							url : "http://www.1616dh.com/s.php?v&q="
						},
						submitData : {
						...
						buttonText : "搜索",
						logo : {
							img : "/images/skins/AsianGames/cooperator/multisearch.2011021201.gif",
							url : "http://s.maxthon.com/"
						},
						submitData : {
				...
				engines : [{
						...
						buttonText : "搜索",
						logo : {
							img : "/images/skins/AsianGames/cooperator/youku.2011021701.gif",
						...
						buttonText : "百度一下",
						logo : {
							img : "/images/skins/AsianGames/cooperator/baidu_video.2011021201.gif",
						...
						buttonText : "Google",
						logo : {
							img : "/images/skins/AsianGames/cooperator/google_video.2011021201.gif",
							url : "http://www.google.com.hk/videohp?client=aff-maxthon-dh&hl=zh-cn&tab=wv"
						},
						submitData : {
						...
						buttonText : "搜索",
						logo : {
							img : "/images/skins/AsianGames/cooperator/xunlei.2011021701.gif",
				...
				engines : [{
						...
						buttonText : "百度一下",
						logo : {
							img : "/images/skins/AsianGames/cooperator/baidu_image.2011021201.gif",
						...
						buttonText : "Google",
						logo : {
							img : "/images/skins/AsianGames/cooperator/google_image.2011021201.gif",
				...
				engines : [{
						...
						buttonText : "百度一下",
						logo : {
							img : "/images/skins/AsianGames/cooperator/baidu_mp3.2011021201.gif",
						...
						buttonText : "Google",
						logo : {
							img : "/images/skins/AsianGames/cooperator/google_music.2011021201.gif",
							url : "http://www.google.cn/music/homepage?client=aff-maxthon-dh&hl=zh-cn&tab=wU"
						},
						submitData : {
				...
				engines : [{
						...
						buttonText : "百度一下",
						logo : {
							img : "/images/skins/AsianGames/cooperator/baidu_knowledge.2011021201.gif",
						...
						buttonText : "百度一下",
						logo : {
							img : "/images/skins/AsianGames/cooperator/baidu_baike.2011021701.gif",
						...
						buttonText : "搜索",
						logo : {
							img : "/images/skins/AsianGames/cooperator/wiki.2011021701.gif",
				...
				engines : [{
						...
						buttonText : "百度一下",
						logo : {
							img : "/images/skins/AsianGames/cooperator/baidu_map.2011021201.gif",
						...
						buttonText : "Google",
						logo : {
							img : "/images/skins/AsianGames/cooperator/google_map.2011021201.gif",
							url : "http://ditu.google.cn/maps?client=aff-maxthon-dh&hl=zh-cn&tab=wl"
						},
						submitData : {
				...
				engines : [{
						...
						buttonText : "搜宝贝",
						logo : {
							img : "/images/skins/AsianGames/cooperator/taobao.2011021201.gif",
							url : "http://www.taobao.com/?mode=&ref=&ali_trackid=2%3Amm_12431063_0_0%3A92705700_2_282229071"
						},
						submitData : {
							action : "http://search8.taobao.com/browse/search_auction.htm",
							params : {
								pid : "mm_12431063_2220385_9100145",
								commend : "all",
								search_type : "auction",
						...
						buttonText : "搜宝贝",
						logo : {
							img : "/images/skins/AsianGames/cooperator/dd.2011021201.gif",
							url : "http://union.dangdang.com/transfer/transfer.aspx?from=P-271135-shouyedaohang&backurl=http://www.dangdang.com"
						},
						submitData : {
						...
						buttonText : "搜宝贝",
						logo : {
							img : "/images/skins/AsianGames/cooperator/joyo.2011021201.gif",
						...
						buttonText : "搜宝贝",
						logo : {
							img : "/images/skins/AsianGames/cooperator/360buy.2011021201.gif",
							url : "http://p.yiqifa.com/c?s=0c85d6b8&w=176126&c=4509&i=5862&l=0&e=&t=http://www.360buy.com"
						},
						submitData : {
				...
				engines : [{
						...
						buttonText : "Google",
						logo : {
							img : "/images/skins/AsianGames/cooperator/google_translate.2011021201.gif",
							url : "http://translate.google.cn/?client=aff-maxthon-dh&hl=zh-cn&tab=wT#"
						},
						submitData : {
...
Core.reg("widget-center", function (j) {
		...
		j.listen("start-widget-center", function (v) {
				...
				if (mxapi.version != "other") {
					if (mxapi.history.lastOpenList().length > 0 && mxapi.history.defaultPopup()) {
						n.click($.inArray("last", m));
					}
				}
			});
...
Core.reg("main", function (d) {
		var g = [{
				title : "百&nbsp;度",
				link : "http://www.baidu.com/index.php?tn=myie2&ch=1"
			}, {
				title : "Google谷歌",
				link : "http://www.google.com.hk/webhp?client=aff-maxthon-dh"
			}, {
				title : "新&nbsp;浪",
				...
				title : "人人网",
				link : "http://wwv.renren.com/xn.do?ss=17043&rt=2&g=mt"
			}, {
				title : "开心网",
				...
				title : "当当购物",
				link : "http://union.dangdang.com/transfer/transfer.aspx?from=P-271135-shouyedaohang&backurl=http://www.dangdang.com"
			}, {
				title : "联合早报    ",
				link : "http://www.zaobao.com/"
			}, {
				title : "Yahoo雅虎",
				link : "http://cn.yahoo.com/"
			}, {
				title : "西祠胡同    ",
				link : "http://www.xici.net/"
			}, {
				title : "瑞丽女性网",
				link : "http://www.rayli.com.cn/"
			}, {
				title : "京东商城",
				link : "http://p.yiqifa.com/c?s=313b88d8&w=102801&c=4509&i=5862&l=0&e=cy&t=http://union.360buy.com/Union_default.aspx"
			}, {
				title : "卓越网",
				link : "http://www.amazon.cn/?source=maxthon"
			}, {
				title : "中关村在线",
				...
				title : "迅雷看看    ",
				link : "http://www.xunlei.com/"
			}, {
				title : "一听音乐",
				link : "http://www.1ting.com/"
			}, {
				title : "NBA中国官方站",
				link : "http://nba.tom.com/"
			}, {
				title : "东方财富    ",
				...
				title : "携程网",
				link : "http://p.yiqifa.com/c?s=d6292082&w=628&c=297&i=406&l=0&d=151&e=11&t=http://www.ctrip.com/smartlink/smartlink.asp"
			}, {
				title : "金融界    ",
				link : "http://www.jrj.com.cn/?from=91002_1"
			}, {
				title : "工商银行    ",
				link : "http://www.icbc.com.cn/icbc/"
			}, {
				title : "4399小游戏",
				link : "http://www.4399.net/"
			}, {
				title : "QQ空间",
				link : "http://qzone.qq.com/index.html"
			}, {
				title : "7K7K小游戏",
				...
				title : "世纪佳缘",
				link : "http://www.jiayuan.com/st/?id=4136&url=http://www.jiayuan.com"
			}, {
				title : "4399网页游戏",
				link : "http://web.4399.com/?cid=2107&uid=1009"
			}, {
				title : "起点中文网",
				link : "http://www.qidian.com/"
			}, {
				title : "去哪儿·机票",
				link : "http://www.qunar.com/twell/redirect.jsp?url=http://www.qunar.com?dh=ayo2"
			}, {
				title : "赶集网",
				link : "http://www.ganji.com/"
			}, {
				title : "淘宝皇冠店",
				link : "http://pindao.huoban.taobao.com/channel/shop_street.htm?pid=mm_12431063_2220385_8721096 "
			}, {
				title : "搜房网",
				link : "http://count.soufun.com/Max_V3.php?site=http://www.soufun.com"
			}, {
				title : "Mtime时光网",
				link : "http://www.mtime.com/"
			}, {
				title : "vancl凡客诚品",
				link : "http://www.vancl.com/?source=yimadaohang-maxthon"
			}, {
				title : "阿里巴巴",
				link : "http://china.alibaba.com/?cosite=aoyou&location=homepage_mzdh"
			}, {
				title : "招商银行信用卡",
				link : "http://creditcard.cmbchina.com/"
			}
		];
		var a = $("#website-list");
		var c = $(".more", d.host());
		...
		d.listen("hook-websites", function (j) {
				if (j.resources) {
					for (var h in j.resources) {
						g[h] = j.resources[h];
					}
				}
				if (j.order) {
		...
		d.listen("start-websites", function (h) {
				a.links(g, e);
			});
		$("#main-btn-more").click(function (h) {
				h.preventDefault();
				window.open("http://www.13393.com/");
			});
		if (mxapi.version != "other") {
			$("#main-tabs").append($("<a href='#'><span><span class='tab-border-left'></span><span class='tab-content'>经常访问网站</span><span class='tab-border-right'></span></span></a>"));
			$(".module-body", d.host()).append($("<div></div>", {
						id : "favorites",
						"class" : "panel",
						"data-name" : "d1-0"
					}));
			var f = $.cookieAdvanced("ch.new", "main-tab") || 0;
			$("#main-tabs").tabs("#main .module-body .panel", {
					initialIndex : f,
					onClick : function (i, h) {
						var j = $(this.getPanes()[h]);
						if (j.data("loaded") == undefined) {
							d.notify("click-main-tab", {
									index : h
								});
							j.data("loaded", true);
						}
						$.cookieAdvanced("ch.new", "main-tab", h);
						d.statistic({
								n : $("#main-tabs").find("a").eq(h).text(),
								m : "d"
							});
						c.children().each(function (l, m) {
								var k = l - 2;
								if (k < 0) {
									return;
								}
...
Core.reg("taobao", function (c) {
		var a = "http://top.taobao.com/interface_v2.php?trid=TR_zongbang&n=10&up=false&f=json&pid=mm_12431063_2220385_9100145&from=maxthon";
		...
		$("#taobao-btn-more").click(function (f) {
				c.notify("show-widget", {
						id : "shopping"
					});
				f.preventDefault();
			});
		c.listen("start-taobao-cats", function (f) {
				b(f);
				if (f.textLink.items === undefined) {
					c.request({
							type : "script",
							url : a
						}, function () {
							var g = top_data.cat_toprank.toprank_list.toprankid_TR_zongbang.data;
							$(g).each(function (h, i) {
									i.text = i.OBJECT_NAME;
									i.url = i.search_url;
								});
							e(f, g);
						});
				} else {
					e(f, f.textLink.items);
				}
			});
		c.listen("start-taobao-shops", function (f) {
				d(f);
			});
		function e(m, j) {
			var h = [];
			...
			var n = "";
			var k = 0;
			var f = c.host().find(".text-link");
			h.push('<a href="' + m.textLink.captionUrl + '" title="' + m.textLink.caption + '" target="_blank" class="caption">' + m.textLink.caption + "</a>");
			for (k = 0; k < j.length; k++) {
				l = j[k];
				g = l.text;
				n = l.url;
				h.push('<a href="' + n + '" title="' + g + '" target="_blank" class="item">' + g + "</a>");
			}
			f.html(h.join(""));
		}
		function b(g) {
			var i = g.imageLink;
			var h = null;
			var f = c.host().find(".image-link");
			$(i).each(function (j, k) {
					h = $("#taobao-image-link-template").clone();
					h.css("display", "block");
					h.removeAttr("id");
					h.find(".image").attr({
							"data-name" : k.text,
		...
		function d(m) {
			...
			for (var i = 0; i < k.length; i++) {
				l = k[i];
				f.push('<li><a href="' + l.url + '" title="' + l.name + '" target="_blank" data-name="' + l.name + '">' + l.name + "</a></li>");
			}
			h.find("ul").html(f.join(""));
		}
		$(window).load(function () {
				$("#taobao-s-key").val("");
			});
	});
Core.reg("games", function (e) {
		var c = "";
		var f = {
			headline : [{
					title : "明朝时代",
					summary : "回明朝,闯天下,亲身体验明朝那些事儿",
					link : "http://mcsd.qq937.com/314/ ?cid=2107&uid=3074",
					img : c + "/images/pictures/gf_mcsd0927.jpg"
				}, {
					title : "凡人修真",
					summary : "冲破尘世凡人修真带你开创求真圣境",
					link : "http://frxz.qq937.com/tan12/ l ?cid=2107&uid=3072",
					img : c + "/images/pictures/gf_frxz0927.jpg"
				}
			],
			list : [{
					link : "http://zjcq.qq937.com/xcy2/index.html ?cid=2107&uid=1009",
					title : "战将传奇"
				}, {
					link : "http://frxz.qq937.com/486/index.html?cid=2107&uid=1009",
					title : "凡人修真"
				}, {
					link : "http://mcsd.qq937.com/1/index.html?cid=2107&uid=3074",
					title : "明朝时代"
				}, {
					link : "http://plsm.qq937.com/255/index.html?cid=2107&uid=1009",
					title : "盘龙神墓"
				}, {
					link : "http://www.qq627.cn/456/index.html?cid=2107&uid=1009",
					title : "热血三国"
				}, {
					link : "http://www.qq908.cn/312/index.html?cid=2107&uid=1009",
					title : "弹弹堂"
				}, {
					link : "http://mhxx.qq937.com/610/index.html?cid=2107",
					title : "梦幻修仙"
				}, {
					link : "http://ftxy.qq937.com/465/index.html?cid=2107&uid=1009",
					title : "飞天西游"
				}, {
					link : "http://yzh.qq937.com/tan2/index.html?cid=2107&uid=1009",
					title : "玉之魂"
				}, {
					link : "http://qq806.cn/6/index.html?cid=2107&uid=1009",
					title : "商业大亨"
				}, {
					link : "http://www.4399.com/flash/1382_2.htm?1024",
					title : "宠物连连看2"
				}, {
					link : "http://www.4399.com/flash/12669_4.htm?1024",
					title : "果蔬连连看"
				}, {
					link : "http://www.4399.com/flash/seer.htm",
					title : "赛尔号"
				}, {
					link : "http://www.51mole.com/",
					title : "摩尔庄园"
				}, {
					link : "http://www.4399.com/flash/8762_2.htm?1024",
					title : "超级玛丽"
				}, {
					link : "http://www.4399.com/flash/1602_2.htm?1024",
					title : "黄金矿工"
				}, {
					link : "http://www.4399.com/flash/10379.htm",
					title : "奥比岛"
				}, {
					link : "http://dn.sdo.com/",
					title : "龙之谷"
				}, {
					link : "http://www.warcraftchina.com/index.html",
					title : "魔兽世界"
				}, {
					link : "http://dnf.qq.com/main.shtml",
					title : "地下城与勇士"
				}
			]
		};
		e.listen("hook-games", function (g) {
				if (g.headline) {
					$.each(g.headline, function (l, k) {
							for (var h in k) {
								f.headline[l - 1][h] = k[h];
							}
						});
				}
				if (g.list) {
					$.each(g.list, function (l, k) {
							for (var h in k) {
								f.list[l - 1][h] = k[h];
							}
						});
		...
		var a = function () {
			...
			$.each(h, function (k, j) {
					var m = j.title;
					var l = decodeURIComponent(j.link);
					i += '<div class="headLine clearfix"><a data-name="' + m + '" data-action="img" href="' + l + '" class="img" title="' + m + '" target="_blank"><img src="' + j.img + '" width="100px" height="120" /></a><div class="info"><h4><a data-name="' + m + '" data-action="title" href="' + l + '" class="title" title="' + m + '" target="_blank">' + m + '</a></h4><span class="desc">' + j.summary + '</span><span class="btn"><a data-name="' + m + '" data-action="button" href="' + l + '" class="button" title="' + m + '" target="_blank">进入游戏</a><span class="right"></span></span></div></div>';
				});
			$(".headline", b).html(i);
			$(".btn", b).hover(function () {
					$(this).addClass("btn-hover");
		...
		var d = function () {
			$(".btn-more", b).click(function (g) {
					e.notify("show-widget", {
							id : "games"
						});
					g.preventDefault();
				});
		};
		e.listen("start-games", function () {
				a();
				d();
			});
	});
Core.reg("mx3-popularization", function (h) {
		var k = "banner";
		var d = "float";
		var e = "banner&float";
		var a = "";
		...
		function i() {
			...
			l.id = "mx3-popularization-banner";
			l.className = "mx3-popularization-banner module layout-row";
			l.onclick = function () {
				h.statistic({
						m : "杂项",
						n : "点击推广(横幅)"
			...
			var m = $("<a></a>", {
					href : "#",
					"class" : "mx3-popularization-banner-close",
					click : function (n) {
						n.preventDefault();
						n.stopPropagation();
						h.statistic({
			...
			m.appendTo(l);
			document.getElementById("wrapper").insertBefore(l, document.getElementById("news-bar"));
		}
		function g() {
			var l = document.createElement("iframe");
			l.id = "mx3-popularization-float";
			l.className = "mx3-popularization-float";
			l.src = "http://i.maxthon.cn/html/mx3_popularization.htm?v=" + h.getCacheVersion() + "&url=" + b;
			l.frameBorder = "no";
			l.border = "0";
		...
		function j() {
			var m = $.cookieAdvanced("ch.startpage.mx3.popularization");
			var l = false;
			if (m) {
				if ((new Number(m)) < f) {
					l = true;
					$.cookieAdvanced("ch.startpage.mx3.popularization", null, f);
				} else {
					l = false;
				}
			} else {
		...
		h.listen("[mx3-popularization]get-ad-style", function (l) {
				a = l.style;
				f = l.toggle;
				b = l.url;
				if (!j()) {
