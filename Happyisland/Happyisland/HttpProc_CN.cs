...
namespace Happyisland
{
    ...
    ///<param name="e"></param>
    public delegate void WebClientUploadEvent(object sender, Happyisland.UploadEventArgs e);
    ...
    ///<param name="sender"></param>
    ///<param name="e"></param>
    public delegate void WebClientDownloadEvent(object sender, Happyisland.DownloadEventArgs e);
    ...
    public class WebClient
    {
        ...
        public string OpenRead(string URL, string postData)
        {
            ...
            requestHeaders.Add("Connection", "Keep-Alive");
            requestHeaders.Add("Keep-Alive", "300");
            requestHeaders.Add("Accept-Charset:gb2312,utf-8;q=0.7,*;q=0.7");
        ...
        private byte[] GetRequestHeaders(string request)
        {
            ...
            requestHeaders.Add("User-Agent", "Mozilla/5.0 (Windows; U; Windows NT 6.1; zh-CN; rv:1.9.2.6) Gecko/20100625 Firefox/3.6.6");
