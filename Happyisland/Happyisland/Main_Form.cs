...
namespace Happyisland
{
    public partial class Main_Form : Form
    {
        ...
        Happyisland.WebClient HTTPproc = new WebClient();
        Happyisland.WebClient HTTPproc_1 = new WebClient();
        ...
        private void LoadUserInfo()
        {
            ...
            label_Main_Form_UserID.Text = "小岛ID:" + (string)o["user"]["uid"];
        ...
        private void LoadFriends()
        {
            ...
            //TableModel tableModel_Main_Form_FriendList = new TableModel();
            for (int i = 0; i < friends.Count(); i++)
            {
                string strName = (string)friends[i]["name"];
                //int j = i;
                if (strName != "乐乐")
                {
                    ...
                    //Row rw = new Row();
                    //rw.Cells.Add(new Cell((string)friends[i]["uid"]));
                    //rw.Cells.Add(new Cell((string)friends[i]["name"]));
                    //rw.Cells.Add(new Cell((string)friends[i]["level"]));
                    //this.tableModel_Main_Form_FriendList.Rows.Add(rw);
                }
            }
            ShowSysLog("好友列表加载完成");
