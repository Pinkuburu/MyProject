...
namespace BDBBS_SendMessage
{
    ...
    ///<param name="e"></param>
    public delegate void WebClientUploadEvent(object sender, BDBBS_SendMessage.UploadEventArgs e);
    ...
    ///<param name="sender"></param>
    ///<param name="e"></param>
    public delegate void WebClientDownloadEvent(object sender, BDBBS_SendMessage.DownloadEventArgs e);
