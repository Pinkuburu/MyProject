    ...
    class DataCenter_Game
    {
        static void Main(string[] args)
        {
            if (args.Length > 0)  //有参数调用
            {
                ...
                else if(args[0].ToLower().ToString() == "delmatch")
                {
                    DeleteMatchXML();
                    Console.WriteLine("============ 比赛战报删除完成！============");
                }
        ...
        {
            return ServerSelector.Copartner;
        }
        #endregion 获取服务器所在区
        ...
        private static string GetDataCenterConnString(int intServerCategory)
        {
            ...
            {
                case 1://数据中心服务器
                    strReturn = @"Data Source=222.73.57.140,2149;Initial Catalog=Fx_Main;Persist Security Info=True;User ID=Fx_Admin;Password=qweqwe123";
                    break;
                case 2://测试服务器
        ...
        #region 删除篮球游戏服务器比赛战报 DeleteMatchXML()
        /// <summary>
        /// DeleteMatchXML()
        /// </summary>
        private static void DeleteMatchXML()
        {
