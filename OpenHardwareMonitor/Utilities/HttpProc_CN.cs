...
namespace OpenHardwareMonitor.Utilities
{
    ...
    ///<param name="e"></param>   
    public delegate void WebClientUploadEvent(object sender, OpenHardwareMonitor.Utilities.UploadEventArgs e);
    ...
    ///<param name="sender"></param>   
    ///<param name="e"></param>   
    public delegate void WebClientDownloadEvent(object sender, OpenHardwareMonitor.Utilities.DownloadEventArgs e);
