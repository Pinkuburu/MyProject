...
namespace LFNet.QQ.Packets.In
{
    ...
    {
        /// <summary>用于发送确认
        /// 	<remark>abu 2008-04-22 </remark>
        /// </summary>
        /// <value></value>
        public byte[] Reply { get; set; }
        /// <summary>为true时表示收到的消息是空的
        /// 	<remark>abu 2008-04-22 </remark>
        /// </summary>
        /// <value></value>
        ...
        public ReceiveIMPacket(ByteBuffer buf, int length, QQClient client) : base(buf, length, client) { }
        ...
        {
            ClusterIM = new ClusterIM(Client, RecvSource.UNKNOWN_CLUSTER);
            ClusterIM.Read(buf);
        }
        /// <summary>解析临时组消息
        ...
        {
            ClusterIM = new ClusterIM(Client, RecvSource.TEMP_CLUSTER);
            ClusterIM.Read(buf);
        }
        /// <summary>解析群普通消息
        /// 	<remark>abu 2008-02-26 </remark>
        /// </summary>
        /// <param name="buf">The buf.</param>
        private void ParseClusterIM09(ByteBuffer buf)
        {
            ClusterIM = new ClusterIM(Client, RecvSource.CLUSTER_09);
            ClusterIM.Read(buf);
        }
        /// <summary>解析群普通消息
        /// 	<remark>abu 2008-02-26 </remark>
        ...
        {
            ClusterIM = new ClusterIM(Client, RecvSource.CLUSTER);
            ClusterIM.Read(buf);
        }
        /// <summary>
        /// 解析系统消息
