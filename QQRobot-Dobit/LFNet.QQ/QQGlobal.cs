...
namespace LFNet.QQ
{
    ...
    {
        /// <summary>
        /// 消息最大长度，QQ是最大699字节   LumaQQ里说最长是700，但是我试下来只能是699，700就会出错，不知道为什么
        /// <author>蓝色的风之精灵</author>
        /// </summary>
        public const int QQ_MAX_SEND_IM = 699;
        /// <summary>
        /// 包最大大小
        /// </summary>
        ...
        ///  QQ缺省编码方式
        /// </summary>
        public const string QQ_CHARSET_DEFAULT = "UTF-8"; //"GBK";
        ...
        /// 程序缺省使用的客户端版本号
        /// </summary>
        public static char QQ_CLIENT_VERSION = QQ_CLIENT_VERSION_2009_P;//QQ_CLIENT_VERSION_0E1B;

        /// <summary>
        /// 客户端版本号标志 - QQ2005 
        /// </summary>
        public const char QQ_CLIENT_VERSION_0E1B = (char)0x0E1C;

        /// <summary>
        /// 客户端版本号标志 - QQ2009 正式版
        /// </summary>
        public const char QQ_CLIENT_VERSION_2009_ZS =(char) 0x1645;
        public const char QQ_CLIENT_VERSION_2009_P = (char)0x1663;
        /// <summary>
        ...
        /** 单位: ms */
        public const long QQ_TIMEOUT_SEND = 5000;//5s有点短改成10s吧
        /** 最大重发次数 */
        public const int QQ_MAX_RESEND = 3;
    ...
    /// 命令常量
    /// </summary>
    public enum QQCommand2005 : ushort
    {
        /// <summary>
        ///  登出
        /// </summary>
        ...
        /// 临时会话操作
        /// </summary>
        Temp_Session_OP = 0x00E1,   //尝试0x0066 改为 0x00E1
        /// <summary>
        /// 个性签名的操作 
        /// </summary>
        Signature_OP = 0x0067,
    ...
    public enum ClusterSubCmd : byte
    {
        ...
        /// <summary>
        /// 添加成员，用在修改成员列表命令中(在LumaQQ中没有看到这个功能实现)
        /// </summary>
        ADD_MEMBER = 0x01,
        /// <summary>
        /// 删除成员，用在修改成员列表命令中(在LumaQQ中没有看到这个功能实现)
        /// </summary>
        REMOVE_MEMBER = 0x02      
    }
    ...
    public enum AddFriendAuthSubCmd : byte
    { 
        /// <summary>
        /// 加对方为好友时，对方不需要认证时
        /// </summary>
        Add=0x00,
        //(01表示不需要验证时的加对方为好友,03表示接受并加对方为好友,04表示只接受,05表示拒绝)
        /// <summary>
        /// 不需要验证时的加对方为好友 unknown this cmd To Use
        /// </summary>
        NoAuth=0x01,
        /// <summary>
        /// 发送请求认证信息 当加对方为好友需要认证时
        /// </summary>
        NeedAuthor=0x02,
        /// <summary>
        /// 接受并加对方为好友
    ...
    ///  加入群的回复码
    /// </summary>
    public enum ClusterJoinReply : byte
    {
        /// <summary>
        /// 加入成功
        /// </summary>
