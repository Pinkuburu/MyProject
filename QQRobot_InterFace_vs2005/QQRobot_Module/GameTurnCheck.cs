...
namespace QQRobot_Module
{
    public class ServerCheck
    {
        ...
        public string GetGameTurn(string strProject)
        {
            ...
            if (strProject == "BB")
            {
                arrServer = new string[] { "XBA", "CGA", "17173", "TW", "SINA", "CGC", "KX", "PPS", "YL", "RR", "NXBA" };//, "NBA"
            }
            else
            {
                arrServer = new string[] { "XBAF", "XBAF3", "17173F", "SINAF", "TT", "ESL", "MOP", "PPSF", "TWF", "TY", "PPL", "PPS2F", "7K7K", "YXY", "92PK", "TOM", "QIDIAN", "37WAN", "9YOU", "JUU", "QIDIAN2", "RRF", "5A", "RRF", "HL", "ZMR", "JJ", "CGAF", "51WANF", "37WAN2", "YW", "MYY", "QIDIAN3", "QIDIAN4", "LZ", "56", "ESL", "360", "KX001", "CNTV", "QIDIAN5", "TWF3", "PPSF3", "9377" };//, "NBAF"
            }
        ...
        public string GetGameSeason(string strKeywords)
        {
            ...
            arrProject_BB = new string[] { "XBA", "CGA", "17173", "TW", "SINA", "CGC", "KX", "PPS", "YL", "RR", "NXBA" };//, "NBA"
            arrProject_FB = new string[] { "XBAF", "XBAF3", "17173F", "SINAF", "TT", "ESL", "MOP", "PPSF", "TWF", "TY", "PPL", "PPS2F", "7K7K", "YXY", "92PK", "TOM", "QIDIAN", "37WAN", "9YOU", "JUU", "QIDIAN2", "RRF", "5A", "RRF", "HL", "ZMR", "JJ", "CGAF", "51WANF", "37WAN2", "YW", "MYY", "QIDIAN3", "QIDIAN4", "LZ", "56", "ESL", "360", "KX001", "CNTV", "QIDIAN5", "TWF3", "PPSF3", "9377" };//, "NBAF"
        ...
        public string GetOnlineMax()
        {
            ...
            for (j = 0; j < arrServer.Length; j++)
            {
                ...
                try
                {
                    for (i = 0; i < arrCategory.Length; i++)
                    {
                        string strSQL = "SELECT MAX(USERCOUNT) AS Count FROM USERONLINECOUNT WITH(NOLOCK) WHERE Createtime>'2011-5-16'";
                        dr = SqlHelper.ExecuteDataRow(DBConnection.Get30GamePhoneConnString(Convert.ToInt32(arrCategory[i].ToString()), arrServer[j].ToString()), CommandType.Text, strSQL);
                        if (dr != null)
                        {
                            arrResult.Add(string.Format("{0}_{1}_最高在线:{2}", arrServer[j].ToString(), arrServerName[i].ToString(), (int)dr["Count"]));
                        }
                    }
                }
                catch
                {
                    arrResult.Add(string.Format("{0}_{1}_连接超时", arrServer[j].ToString(), arrServerName[i].ToString()));
                }                
            }
