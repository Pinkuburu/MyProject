...
namespace OnlineWeather_Web
{
    ...
    ///<param name="e"></param>
    public delegate void WebClientUploadEvent(object sender, OnlineWeather_Web.UploadEventArgs e);
    ...
    ///<param name="sender"></param>
    ///<param name="e"></param>
    public delegate void WebClientDownloadEvent(object sender, OnlineWeather_Web.DownloadEventArgs e);
