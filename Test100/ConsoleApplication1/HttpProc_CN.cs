...
namespace ConsoleApplication1
{
    ...
    ///<param name="e"></param>
    public delegate void WebClientUploadEvent(object sender, ConsoleApplication1.UploadEventArgs e);
    ...
    ///<param name="sender"></param>
    ///<param name="e"></param>
    public delegate void WebClientDownloadEvent(object sender, ConsoleApplication1.DownloadEventArgs e);
