...
(function(i) {
    ...
    i.jcarousel = function(a, c) {
        ...
        for (var b = "",
        d = a.className.split(" "), f = 0; f < d.length; f++) if (d[f].indexOf("jcarousel-skin") != -1) {
            i(a).removeClass(d[f]);
            b = d[f];
            break
        }
    ...
    h.fn.extend({
        ...
        pos: function(a, c) {
            ...
            f = this.options.wrap != "circular" && this.first <= 1 ? 1 : this.first, j = d ? this.get(f) : this.get(this.last), e = d ? f: f - 1, g = null, k = 0, l = false, m = 0; d ? --e >= a: ++e < a;) {
                g = this.get(e);
                l = !g.length;
                if (g.length === 0) {
