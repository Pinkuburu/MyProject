...
namespace QQRobot_Module
{
    public class ServerCheck
    {
        ...
        public string GetGameTurn(string strProject)
        {
            ...
            if (strProject == "BB")
            {
                arrServer = new string[] { "XBA", "CGA", "17173", "SOHU", "TW", "DW", "SINA", "CGC", "KX", "5S", "PPS", "YL", "HP", "RR", "NXBA" };//, "NBA"
            }
            else
            {
                arrServer = new string[] { "XBAF", "XBAF2", "XBAF3", "DWF", "17173F", "SINAF", "SINA2F", "TT", "ESL", "MOP", "PPSF", "TWF", "TY", "PPL", "SOHUF", "PPS2F", "7K7K", "YXY", "TOM" };//, "NBAF"
            }
        ...
        public string GetGameSeason(string strKeywords)
        {
            ...
            arrProject_BB = new string[] { "XBA", "CGA", "17173", "SOHU", "TW", "DW", "SINA", "CGC", "KX", "5S", "PPS", "YL", "HP", "RR", "NXBA" };//, "NBA"
            arrProject_FB = new string[] { "XBAF", "XBAF2", "XBAF3", "DWF", "17173F", "SINAF", "SINA2F", "TT", "ESL", "MOP", "PPSF", "TWF", "TY", "PPL", "SOHUF", "PPS2F", "7K7K", "YXY", "TOM" };//, "NBAF"
