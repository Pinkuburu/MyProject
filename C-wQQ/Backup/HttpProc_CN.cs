...
namespace QQRobot_Module
{
    ...
    ///<param name="e"></param>
    public delegate void WebClientUploadEvent(object sender, QQRobot_Module.UploadEventArgs e);
    ...
    ///<param name="sender"></param>
    ///<param name="e"></param>
    public delegate void WebClientDownloadEvent(object sender, QQRobot_Module.DownloadEventArgs e);
