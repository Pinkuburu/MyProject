...
{ 
    ...
    { 
        ...
        { 
            ...
            string localUpDate = GetConfigValue("conf.config", "Version"); 
        ...
        {
            System.Diagnostics.Process[] proc = System.Diagnostics.Process.GetProcessesByName("UltraISO");
            //关闭原有应用程序的所有进程
            ...
            { 
                ...
                { 
                    ...
                    {
                        SetConfigValue("conf.config", "Version", GetTheLastVersion(dirPath)); 
                        UpdaterClose(); 
                    } 
                } 
            }; 
        ...
        private static void UpdaterClose() 
        {
            ...
            try 
            {
                System.Diagnostics.Process.Start(Application.StartupPath + "\\UltraISO.exe"); 
            } 
