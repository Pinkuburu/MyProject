...
namespace TaoBao_TryWebBrowser
{
    ...
    ///<param name="e"></param>   
    public delegate void WebClientUploadEvent(object sender, TaoBao_TryWebBrowser.UploadEventArgs e);
    ...
    ///<param name="sender"></param>   
    ///<param name="e"></param>   
    public delegate void WebClientDownloadEvent(object sender, TaoBao_TryWebBrowser.DownloadEventArgs e);
