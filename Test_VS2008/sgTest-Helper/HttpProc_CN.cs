...
namespace sgTest_Helper
{
    ...
    ///<param name="e"></param>   
    public delegate void WebClientUploadEvent(object sender, sgTest_Helper.UploadEventArgs e);
    ...
    ///<param name="sender"></param>   
    ///<param name="e"></param>   
    public delegate void WebClientDownloadEvent(object sender, sgTest_Helper.DownloadEventArgs e);
    ...
    public class WebClient
    {
        ...
        private void SendRequestData(string URL, string method, bool showProgress)
        {
            ...
            if (URI.Port > 80)
            {                
                requestHeaders.Add("Host", URI.Host + ":" + URI.Port);
            }
            else
            {
                    ...
                    if (M.Success)
                    {
                        ...
                        if (M.Groups[1].Value == "Set-Cookie")
                        {
                            ...
                            for (int i = 0; i < alCookies.Count; i++)
                            {
                                ...
                                if (strTemp.Contains(strCookie_Temp))
                                {
