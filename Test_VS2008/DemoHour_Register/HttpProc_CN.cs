...
namespace DemoHour_Register
{
    ...
    ///<param name="e"></param>   
    public delegate void WebClientUploadEvent(object sender, DemoHour_Register.UploadEventArgs e);
    ...
    ///<param name="sender"></param>   
    ///<param name="e"></param>   
    public delegate void WebClientDownloadEvent(object sender, DemoHour_Register.DownloadEventArgs e);
