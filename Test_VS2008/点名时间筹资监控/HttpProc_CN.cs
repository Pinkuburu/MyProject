...
namespace 点名时间筹资监控
{
    ...
    ///<param name="e"></param>   
    public delegate void WebClientUploadEvent(object sender, 点名时间筹资监控.UploadEventArgs e);
    ...
    ///<param name="sender"></param>   
    ///<param name="e"></param>   
    public delegate void WebClientDownloadEvent(object sender, 点名时间筹资监控.DownloadEventArgs e);
