...
namespace DemoHour_SearchUser
{
    ...
    ///<param name="e"></param>   
    public delegate void WebClientUploadEvent(object sender, DemoHour_SearchUser.UploadEventArgs e);
    ...
    ///<param name="sender"></param>   
    ///<param name="e"></param>   
    public delegate void WebClientDownloadEvent(object sender, DemoHour_SearchUser.DownloadEventArgs e);
