...
namespace AttendanceHelper
{
    ...
    ///<param name="e"></param>   
    public delegate void WebClientUploadEvent(object sender, AttendanceHelper.UploadEventArgs e);
    ...
    ///<param name="sender"></param>   
    ///<param name="e"></param>   
    public delegate void WebClientDownloadEvent(object sender, AttendanceHelper.DownloadEventArgs e);
