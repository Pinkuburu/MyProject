...
namespace 优酷关键词排行
{
    ...
    ///<param name="e"></param>   
    public delegate void WebClientUploadEvent(object sender, 优酷关键词排行.UploadEventArgs e);
    ...
    ///<param name="sender"></param>   
    ///<param name="e"></param>   
    public delegate void WebClientDownloadEvent(object sender, 优酷关键词排行.DownloadEventArgs e);
