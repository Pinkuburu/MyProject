...
namespace Chuisax顶贴机
{
    ...
    ///<param name="e"></param>   
    public delegate void WebClientUploadEvent(object sender, Chuisax顶贴机.UploadEventArgs e);
    ...
    ///<param name="sender"></param>   
    ///<param name="e"></param>   
    public delegate void WebClientDownloadEvent(object sender, Chuisax顶贴机.DownloadEventArgs e);
