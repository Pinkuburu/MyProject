...
namespace 猫扑WEB领取MOP币
{
    ...
    ///<param name="e"></param>   
    public delegate void WebClientUploadEvent(object sender, 猫扑WEB领取MOP币.UploadEventArgs e);
    ...
    ///<param name="sender"></param>   
    ///<param name="e"></param>   
    public delegate void WebClientDownloadEvent(object sender, 猫扑WEB领取MOP币.DownloadEventArgs e);
