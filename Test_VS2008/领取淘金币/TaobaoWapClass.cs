...
namespace 领取淘金币
{
    public class TaobaoWapClass
    {
        ...
        public string WapLogin(string strUserName, string strPassword)
        {
            ...
            strRequest = "http://login.m.taobao.com/login/login.htm";
            ...
            strRequest = "http://login.m.taobao.com/login/login.htm?" + strSID + "&_input_charset=utf-8";
        ...
        public string FriendCount(string strSID)
        {
            ...
            strRequest = "http://my.m.taobao.com/my_taobao.htm?sid=" + strSID;
