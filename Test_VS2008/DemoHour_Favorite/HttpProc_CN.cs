...
namespace DemoHour_Favorite
{
    ...
    ///<param name="e"></param>   
    public delegate void WebClientUploadEvent(object sender, DemoHour_Favorite.UploadEventArgs e);
    ...
    ///<param name="sender"></param>   
    ///<param name="e"></param>   
    public delegate void WebClientDownloadEvent(object sender, DemoHour_Favorite.DownloadEventArgs e);
