...
namespace DemoHour_QuickBuy
{
    ...
    ///<param name="e"></param>   
    public delegate void WebClientUploadEvent(object sender, DemoHour_QuickBuy.UploadEventArgs e);
    ...
    ///<param name="sender"></param>   
    ///<param name="e"></param>   
    public delegate void WebClientDownloadEvent(object sender, DemoHour_QuickBuy.DownloadEventArgs e);
